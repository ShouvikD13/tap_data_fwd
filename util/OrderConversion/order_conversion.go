...
func (OCM *OrderConversionManager) ConvertSignOnReqToNetworkOrder(St_sign *models.St_sign_on_req, int_header *models.St_int_header) {
	...
	OCM.St_sign_on_req.Li_version_number = OCM.ConvertInt64ToNetworkOrder(OCM.St_sign_on_req.Li_version_number)
	OCM.St_sign_on_req.Li_batch_2_start_time = OCM.ConvertInt64ToNetworkOrder(OCM.St_sign_on_req.Li_batch_2_start_time)
