...
/*Ver 1.1             : View to FML changes	| Samip M													*/
/*Ver 1.2 - 05-Feb-2015 Proper Closing of program(Sachin B)                  */
/*Ver TOL - 14-Aug-2023 Tux on Linux                  (Agam)                  */
/******************************************************************************/
...
/**	#include <fo_view_def.h>	**/	/** Commented for Ver 1.1 **/
...
void CLN_BRD_ENQ ( int argc, char *argv[] )
{
...
int fn_bat_init(int argc, char *argv[])
{
  ...
  strcpy( c_ServiceName, "CLN_BRD_ENQ" );

  if( argc != 4)
  {
    fn_userlog(c_ServiceName,
    "Usage - CLN_BRD_ENQ <Exchange qualifier> <Exchange code> <pipe_id>");
    return -1; 
  }
...
void fn_sgnl_usr2(int i_sig_no)
{
	if(DEBUG_MSG_LVL_3)
	{
  	fn_userlog("cln_brd_clnt","CLN_BRD_ENQ SIGUSER2 exit");
	}
  i_exit_stts = EXIT;
