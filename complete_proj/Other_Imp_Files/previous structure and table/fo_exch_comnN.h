...
/****Ver 3.4 RQ:12754 NNF: Version 9.39: API Changes : Change Open Interest datatype from Long to unsigned Long (Rahul Singh) ***/
// #pragma pack(2)
...
struct st_stats_data
{
	...
	// long int	li_open_interest; Ver 3.4 Commented
	unsigned long int li_open_interest; // Ver 3.4 Added
...
struct st_ticker_index_info
{
	...
	/***Ver 3.4  Comment Start:
	long int  li_open_interest;
	long int  li_high_oi;
	long int  li_low_oi; Comment End***/
	/***Ver 3.4 Added: Start***/
	unsigned long int li_open_interest;
	unsigned long int li_high_oi;
	unsigned long int li_low_oi;
	/***Ver 3.4 Added: End***/
};
...
struct st_oi_data
{
	...
	// long int li_current_oi; Ver 3.4 Commented
	unsigned long int li_current_oi; // Ver 3.4 Added
};
...
struct st_error_response
{
	...
	char c_key[LEN_ERROR_KEY];				 // size 14
	char c_error_message[LEN_ERROR_MESSAGE]; // size 128
};
